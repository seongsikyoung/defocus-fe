          ...
          <div className="flex w-full flex-col">
            {NAV_ITEMS.map((item) => (
              ...
              >
                ...
                <span className={`text-[13px] md:text-[14px] ${item.active ? 'font-bold text-[#3b82f6]' : 'font-medium text-[#64748b] dark:text-[#94a3b8]'}`}>
                  {item.label}
                </span>
                <span className={`text-[8px] md:text-[9px] ${item.active ? 'text-[#3b82f6]' : 'text-[#64748b] dark:text-[#94a3b8]'}`}>
                  {item.sub}
                </span>
              </div>
            ))}
